...
export default function JournalVoucher() {
  ...
  const handleEdit = (item) => {
    navigate(`/editjournalvoucher/${item.id}`);
  };
      ...
      <div className="d-flex flex-row justify-content-start vw-100">
        ...
        >
          ...
          <div style={{ marginTop: 50, padding: "2rem" }}>
            <div className="alert alert-info">Loading journal vouchers...</div>
          </div>
        </div>
      </div>
    );
        ...
        >
          ...
          <div style={{ marginTop: 50, padding: "2rem" }}>
            <div className="alert alert-danger">
              Error loading journal vouchers
            </div>
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div style={{ marginTop: 50, padding: "2rem" }}>
          <DataHeader
            ...
            subtitle="Manage Your Journal Vouchers"
            onAdd={handleAdd}
