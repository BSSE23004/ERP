...
export default function BankReceiptVoucher() {
  ...
  const vouchers =
    allVouchers?.filter((v) => v.voucher_type === "BANK_RECEIPT") || [];
        ...
        >
          ...
          <div style={{ marginTop: 50, padding: "2rem" }}>
            <div className="alert alert-danger">
              Error loading bank receipt vouchers
            </div>
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div style={{ marginTop: 50, padding: "2rem" }}>
          <DataHeader
            ...
            subtitle="Manage Your Bank Receipt Vouchers"
            onAdd={handleAdd}
