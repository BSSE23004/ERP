...
export default function VendorPayment() {
  ...
  const payments =
    allPayments?.filter((p) => p.payment_category === "VENDOR") || [];
  ...
  const handleEdit = (item) => {
    navigate(`/editvendorpayment/${item.id}`);
  };
      ...
      <div className="d-flex flex-row justify-content-start vw-100">
        ...
        >
          ...
          <div style={{ marginTop: 50, padding: "2rem" }}>
            <div className="alert alert-info">Loading vendor payments...</div>
          </div>
        </div>
      </div>
    );
      ...
      >
        ...
        <div style={{ marginTop: 50, padding: "2rem" }}>
          <DataHeader
            ...
            subtitle="Manage Your Vendor Payments"
            onAdd={handleAdd}
            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                <p>
                  ...
                  <strong>{paymentToDelete?.vendor}</strong>?
                </p>
              </div>
