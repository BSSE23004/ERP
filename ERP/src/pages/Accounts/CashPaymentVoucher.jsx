...
export default function CashPaymentVoucher() {
  ...
  const vouchers =
    allVouchers?.filter((v) => v.voucher_type === "CASH_PAYMENT") || [];
        ...
        >
          ...
          <div style={{ marginTop: 50, padding: "2rem" }}>
            <div className="alert alert-danger">
              Error loading cash payment vouchers
            </div>
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div style={{ marginTop: 50, padding: "2rem" }}>
          <DataHeader
            ...
            subtitle="Manage Your Cash Payment Vouchers"
            onAdd={handleAdd}
