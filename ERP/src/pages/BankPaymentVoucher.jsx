...
export default function BankPaymentVoucher() {
  ...
  const LOCAL_KEY = "bank_payment_vouchers";
    ...
    <div className="d-flex flex-row justify-content-start vw-100">
      ...
      >
        ...
        <div style={{ marginTop: 50, padding: "2rem" }}>
          <DataHeader
            title="Bank Payment Voucher List"
            subtitle="Manage Your Bank Payment Voucher"
            onAdd={handleAdd}
            ...
            <div className="modal-dialog">
              <div className="modal-content">
                ...
                <div className="modal-body">
                  Are you sure you want to delete this bank payment voucher?
                </div>
